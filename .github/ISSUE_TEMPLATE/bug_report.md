...
- Redact any PII visible in screenshots
...
If applicable, add screenshots (with PII redacted).

## Additional Context

Any other relevant information (error messages from console, related settings, etc.).
